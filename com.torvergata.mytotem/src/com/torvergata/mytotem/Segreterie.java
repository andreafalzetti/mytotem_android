...
public class Segreterie extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String facolta[] = global.getSEGFacolta();
        numFacoltà = facolta.length;
        ...
        mainListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        	...
        	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
        		...
        		for(int j=0; j<numFacoltà; j++)
        		{
        			//if(global.debug) Log.v("Object", "Object -> " + o.toString());
        			//if(global.debug) Log.v("Facoltà", "Facoltà -> " + global.getSEGFacolta()[j]);
        			if(view == 0 && o.toString().substring(o.toString().indexOf("nome=")+5).equals(global.getSEGFacolta()[j]+"}"))
        			{
        				cambiaListView(global.getSegreterie(j), R.layout.just1row);
        				entrato = true;
        				view = 1;
        			}
        		}
        		...
        		if(entrato==false)
        		{
        			if(global.debug) Log.v("Cambio-activity", "Cambio e mostro il dettaglio della segreteria");
        			Intent i = new Intent(Segreterie.this, DettagliSegreteria.class);
        			String n = o.toString().substring(o.toString().indexOf("nome=")+5);
        			n = n.substring(0, n.length()-1);
        			Log.v("GLI PASSO", n);
        			i.putExtra("nomeSegreteria", n);
        			startActivity(i);
        		}
        	}
        });
